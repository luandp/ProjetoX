 ...
 * @author Luan Paulo
 */
public class TelaGerenciarFolhaPagamento extends javax.swing.JFrame {

    /**
     * Creates new form TelaGerenciarFolhaPagamento
     */
    public TelaGerenciarFolhaPagamento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Gerenciar Folha de Pagamento - ProjetoX");
        ...
        JBtnCadastrar.setText("Realizar Pagamento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGerenciarFolhaPagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGerenciarFolhaPagamento().setVisible(true);
            }
        });
    }
